        ...
        <Popover open={isOpen} onOpenChange={setIsOpen}>
            <PopoverTrigger asChild>
                <Button
                    variant="outline"
                    size="icon"
                    className="relative overflow-hidden border-border bg-background"
                >
            ...
            <PopoverContent>
                ...
                >
                    <TabsList className="flex flex-row space-x-8">
                    ...
                    {activeTab === "mode" ? (
                        <div className="flex flex-row space-x-2">
                            {themeOptions.map((option) => (
                                <Button
                                    ...
                                    className={`w-fit ${theme === option.value ? "border-primary bg-primary/10" : ""}`}
                                >
                                    {option.icon}
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            {colorOptions.map((option) => (
                                ...
                                >
                                    <div
                                        className={`w-8 h-8 rounded-full bg-gradient-to-br ${isDark ? option.darkColor : option.color}`}
                                    />
