...
export default function PostPage() {
    ...
    return (
        <div>
            ...
            <div className='flex gap-5 justify-center'><div className='flex gap-2'><Calendar className='h-10 w-10' /><p className='text-2xl my-auto'>Tarih: {thisEvent?.event_date}</p></div><div className='flex gap-2'><UsersRound className='h-10 w-10' /> <p className='text-2xl my-auto'>Kapasite: {thisEvent?.capacity}</p></div></div>
