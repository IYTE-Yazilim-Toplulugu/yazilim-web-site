...
import MarkdownEditor from "@/components/markdown-editor-calude";
...
export default function CreateBlogPage() {
    ...
    useEffect(() => {
        getUser().then((user) => { setUserData(user); setLoading(false); })
    }, [])
    ...
    return (
        <div className="mt-20 flex justify-center">
            ...
            <div className="relative mt-16 m-4 md:m-16 md:max-w-3xl flex flex-col gap-8">
                ...
                <div>
                    <Label htmlFor="blog-title" className="text-lg font-bold mb-4" >Blog Tags</Label>
